...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo (C("CSS")); ?>demo.css">
            ...
            <div class="col-md-offset-3 col-md-6">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="" placeholder="用户名或电子邮件">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="" id="ver_text" placeholder="请输入验证码">
                        <i class="fa fa-user"></i>
                        <img id="verfiy" src="<?php echo U('Home/Index/verify');?>" alt="点击刷新" title="点击刷新">
                    </div>
                    <div class="form-group">
